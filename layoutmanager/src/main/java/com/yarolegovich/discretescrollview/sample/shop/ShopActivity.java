...
import com.yarolegovich.discretescrollview.sample.weather.ForecastAdapter;
...
public class ShopActivity extends AppCompatActivity implements DiscreteScrollView.OnItemChangedListener<ShopAdapter.ViewHolder>,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        itemPicker.setSlideOnFling(true);   // 是否连续滑动
        itemPicker.addOnItemChangedListener(this);

//        infiniteAdapter = InfiniteScrollAdapter.wrap(new ShopAdapter(data));  // 无限循环
//        itemPicker.setAdapter(infiniteAdapter);
        mShopAdapter = new ShopAdapter(data);
        itemPicker.setAdapter(mShopAdapter);
